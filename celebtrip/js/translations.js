...
const translations = {
  ko: {
    ...
    // JD Fit - Celebtrip Customized
    'jdfit.title': '왜 셀레트립인가',
    'jdfit.subtitle': 'JD 요구사항과 나의 경험이 만나는 지점',
    'jdfit.flutter.req': 'Flutter 3년 내외',
    'jdfit.flutter.exp': '3년 4개월 실무 경험',
    'jdfit.flutter.project': '시선IT + FORLONG',
    'jdfit.architecture.req': 'Clean Architecture',
    'jdfit.architecture.exp': 'Expert 수준, 12모듈 설계',
    'jdfit.architecture.project': 'iLity Hub',
    'jdfit.freezed.req': 'Freezed & dio',
    'jdfit.freezed.exp': '불변 상태 + API 레이어 구축',
    'jdfit.freezed.project': '모든 Flutter 프로젝트',
    'jdfit.global.req': '글로벌 서비스 경험',
    'jdfit.global.exp': '19개 언어 다국어 번역',
    'jdfit.global.project': '이머전시레디앱',
    'jdfit.tracking.req': '이벤트 트래킹',
    'jdfit.tracking.exp': 'Firebase Analytics 구현',
    'jdfit.tracking.project': '안전디딤돌, 포인트투어',
    'jdfit.ai.req': 'AI 인터랙티브 기능',
    'jdfit.ai.exp': 'Llama 3.3 기반 AI 대화',
    'jdfit.ai.project': 'MindLog',
    'jdfit.transaction.req': '커머스 트랜잭션',
    'jdfit.transaction.exp': '포인트 & DeFi 트랜잭션',
    'jdfit.transaction.project': '포인트투어, iLity Hub',
    'jdfit.map.req': '지도 서비스 연동',
    'jdfit.map.exp': 'Google Maps 최적화',
    'jdfit.map.project': '안전디딤돌, 포인트투어',
    'jdfit.note': '<strong>보완점:</strong> GetX, Flutter Web, WeChat Mini Program은 경험이 없지만, Riverpod 전문성과 빠른 학습 능력으로 적응하겠습니다.',
  ...
  en: {
    ...
    // JD Fit - Celebtrip Customized
    'jdfit.title': 'Why Celebtrip',
    'jdfit.subtitle': 'Where JD requirements meet my experience',
    'jdfit.flutter.req': 'Flutter ~3 years',
    'jdfit.flutter.exp': '3 years 4 months hands-on',
    'jdfit.flutter.project': 'Siseon IT + FORLONG',
    'jdfit.architecture.req': 'Clean Architecture',
    'jdfit.architecture.exp': 'Expert level, 12-module design',
    'jdfit.architecture.project': 'iLity Hub',
    'jdfit.freezed.req': 'Freezed & dio',
    'jdfit.freezed.exp': 'Immutable state + API layer',
    'jdfit.freezed.project': 'All Flutter projects',
    'jdfit.global.req': 'Global Service Exp',
    'jdfit.global.exp': '19-language translation',
    'jdfit.global.project': 'EmergencyReady App',
    'jdfit.tracking.req': 'Event Tracking',
    'jdfit.tracking.exp': 'Firebase Analytics impl',
    'jdfit.tracking.project': 'SafeKorea, PointTour',
    'jdfit.ai.req': 'AI Interactive Feature',
    'jdfit.ai.exp': 'Llama 3.3-based AI chat',
    'jdfit.ai.project': 'MindLog',
    'jdfit.transaction.req': 'Commerce Transaction',
    'jdfit.transaction.exp': 'Point & DeFi transactions',
    'jdfit.transaction.project': 'PointTour, iLity Hub',
    'jdfit.map.req': 'Map Service Integration',
    'jdfit.map.exp': 'Google Maps optimization',
    'jdfit.map.project': 'SafeKorea, PointTour',
    'jdfit.note': '<strong>To improve:</strong> No experience with GetX, Flutter Web, WeChat Mini Program, but ready to adapt with Riverpod expertise and fast learning ability.',
