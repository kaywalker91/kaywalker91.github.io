...
const translations = {
  ko: {
    ...
    'projects.dwinsta.summary': 'DW 아카데미 수강 시 개발한 Instagram 클론 앱',
    'projects.dwinsta.highlight1': 'Glide + Picasso 이중 이미지 최적화 전략 (메모리 효율)',
    'projects.dwinsta.highlight2': 'Google Sign-In + Firebase Auth 소셜 인증 통합',
    'projects.dwinsta.highlight3': 'FileProvider 기반 Android N+ 보안 준수',
    'projects.dwinsta.description': 'DW 아카데미 수강 시 개발한 Instagram 클론 앱. Google Sign-In 소셜 인증, 실시간 DM 메시징, Glide + Picasso 이중 이미지 최적화, FileProvider 보안 준수 구현.',
    ...
    'projects.pointtour.badge': '회사 프로젝트',
    'projects.pointtour.summary': '위치기반 포인트적립앱 Android 유지보수 및 신규 기능 개발.',
    'projects.pointtour.highlight1': '"0시축제" 이벤트로 다운로드 400% 증가',
    'projects.pointtour.highlight2': 'RxJava 2 기반 비동기 로직 전면 리팩토링',
    'projects.pointtour.highlight3': '대전시 B2G 프로젝트 협업 경험',
    'projects.pointtour.description': '위치기반 포인트적립 Android 앱. RxJava 2 비동기 로직 리팩토링. 대전시 "0시축제" 이벤트 시스템으로 다운로드 400% 증가 (1,000→5,000회). B2G 프로젝트 수행.',
  ...
  en: {
    ...
    'projects.dwinsta.summary': 'Instagram clone app developed at DW Academy',
    'projects.dwinsta.highlight1': 'Dual image optimization: Glide + Picasso (memory efficiency)',
    'projects.dwinsta.highlight2': 'Social auth integration: Google Sign-In + Firebase Auth',
    'projects.dwinsta.highlight3': 'Android N+ security compliance via FileProvider',
    'projects.dwinsta.description': 'Instagram clone app developed at DW Academy. Implemented Google Sign-In social auth, real-time DM messaging, Glide + Picasso dual image optimization, and FileProvider security compliance.',
    ...
    'projects.pointtour.badge': 'Company Project',
    'projects.pointtour.summary': 'Maintained and expanded Android location-based rewards app.',
    'projects.pointtour.highlight1': '"Zero Hour Festival" campaign → 400% download growth',
    'projects.pointtour.highlight2': 'Full RxJava 2-based async logic refactor',
    'projects.pointtour.highlight3': 'B2G project collaboration with Daejeon city',
    'projects.pointtour.description': 'Location-based point rewards Android app. Refactored async logic with RxJava 2. Developed "Zero Hour Festival" event system, increasing downloads by 400% (1,000→5,000). B2G project experience.',
